...
class UpdateMemberRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'id_card_number' => 'nullable|string|max:20|unique:members,id_card_number,' . $memberId,
    ...
    public function messages(): array
    {
        return [
            ...
            'id_card_number.unique' => 'This ID card number is already registered to another member.',
            'join_date.required' => 'Join date is required.',
            'status.required' => 'Member status is required.',
